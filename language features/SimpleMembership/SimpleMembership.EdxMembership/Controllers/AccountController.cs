...
using SimpleMembership.EdxMembership.Filters;
using System.Web.Mvc;
using SimpleMembership.EdxMembership.ViewModels.EdxMembership;
using WebMatrix.WebData;

namespace SimpleMembership.EdxMembership.Controllers
{
    [Authorize]
